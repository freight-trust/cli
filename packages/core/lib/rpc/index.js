...
const provider = (host, port) => {
    return new (host.startsWith('http') ? http_provider_1.HTTPProvider : ws_provider_1.WSProvider)(host, port);
};
class RPC {
    ...
    async send(method, ...params) {
        var _a;
        return (_a = this.provider) === null || _a === void 0 ? void 0 : _a.send(method, params);
    }
}
exports.default = RPC;
