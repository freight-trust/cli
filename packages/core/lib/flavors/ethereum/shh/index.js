...
class SHH {
  ...
  async shh_getFilterChanges(filterID) {
    return this.connection.rpc.send('shh_getFilterChanges',
  ...
  // }
  async newGroup() { return this.connection.rpc.send('shh_newGroup'); }
  async newIdentity() { return this.connection.rpc.send('shh_newIdentity'); }
  // async shh_post() {
  //   return this.rpc.send('shh_post');
  // }
  async uninstallFilter(filterID) {
    return this.connection.rpc.send('shh_uninstallFilter',
                                    utils_1.hex(filterID));
  }
  async version() { return this.connection.rpc.send('shh_version'); }
}
exports.default = SHH;
