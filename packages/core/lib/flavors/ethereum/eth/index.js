...
class ETH {
    ...
    async call(transaction, blockNumber) {
        return this.connection.rpc.send('eth_call', transaction, utils_1.hexOrQuantifier(blockNumber));
    }
    async coinbase() {
    ...
    async getBalance(address, blockNumberOrTag) {
        return this.connection.rpc.send('eth_getBlockByHash', address, utils_1.hexOrQuantifier(blockNumberOrTag));
    }
    async getBlockByHash(blockHash, includeTransactions = false) {
        return this.connection.rpc.send('eth_getBlockByHash', utils_1.hexOrQuantifier(blockHash), includeTransactions);
    }
    async getBlockByNumber(blockNumber, includeTransactions = false) {
        return this.connection.rpc.send('eth_getBlockByNumber', utils_1.hexOrQuantifier(blockNumber), includeTransactions);
    }
    async getBlockTransactionCountByHash(blockHash) {
        return this.connection.rpc.send('eth_getBlockTransactionCountByHash', utils_1.hex(blockHash));
    }
    async getBlockTransactionCountByNumber(blockNumber) {
        return this.connection.rpc.send('eth_getBlockTransactionCountByNumber', utils_1.hexOrQuantifier(blockNumber));
    }
    ...
    async getFilterChanges(filterId) {
        return this.connection.rpc.send('eth_getFilterChanges', utils_1.hex(filterId));
    }
    ...
    async getTransactionByBlockHashAndIndex(hash, transactionIndex) {
        return this.connection.rpc.send('eth_getTransactionByBlockHashAndIndex', hash, utils_1.hex(transactionIndex));
    }
    async getTransactionByBlockNumberAndIndex(blockNumber, transactionIndex) {
        return this.connection.rpc.send('eth_getBlockTransactionCountByHash', utils_1.hexOrQuantifier(blockNumber), utils_1.hex(transactionIndex));
    }
    ...
    async getUncleByBlockHashAndIndex(hash, uncleIndex) {
        return this.connection.rpc.send('eth_getUncleByBlockHashAndIndex', hash, utils_1.hex(uncleIndex));
    }
    async getUncleByBlockNumberAndIndex(blockNumber, transactionIndex) {
        return this.connection.rpc.send('eth_getUncleByBlockNumberAndIndex', utils_1.hexOrQuantifier(blockNumber), utils_1.hex(transactionIndex));
    }
    ...
    async getUncleCountByBlockNumber(blockNumber) {
        return this.connection.rpc.send('eth_getUncleCountByBlockNumber', utils_1.hexOrQuantifier(blockNumber));
    }
    async getWork() {
    ...
    async sendRawTransaction(data) {
        return this.connection.rpc.send('eth_sendRawTransaction', utils_1.hex(data));
    }
    ...
    async submitWork(nonce, powHash, digest) {
        return this.connection.rpc.send('eth_submitWork', utils_1.hex(nonce), utils_1.hex(powHash), utils_1.hex(digest));
    }
    async uninstallFilter(filterId) {
        return this.connection.rpc.send('eth_uninstallFilter', utils_1.hex(filterId));
    }
    async syncing() {
